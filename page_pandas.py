...
if sous_menu == "Présentation":
    ...
    st.write("Nous allons travailler avec ce fichier [CSV](https://raw.githubusercontent.com/ludovic-simunek/portfolio/refs/heads/main/csv/online_store_customer_data.csv) qui contient environ 2500 lignes et 11 colonnes.")
    import pandas as pd
    
    with st.expander("Convertir ce fichier CSV en DataFrame 'df_csv'"):
        st.code("""
        import pandas as pd
        url="https://raw.githubusercontent.com/ludovic-simunek/portfolio/refs/heads/main/csv/online_store_customer_data.csv"
    ...
    df = pd.read_csv("https://raw.githubusercontent.com/ludovic-simunek/portfolio/refs/heads/main/csv/online_store_customer_data.csv")
    ...
    # Charger le fichier CSV
    df_csv = pd.read_csv("https://raw.githubusercontent.com/ludovic-simunek/portfolio/refs/heads/main/csv/online_store_customer_data.csv")
