...
# Afficher l'image de profil avant le nom
st.sidebar.markdown(
    """
...
st.sidebar.markdown("<p style='margin-bottom: 0;'><img src='https://img.icons8.com/ios-filled/16/000000/phone.png'/> : 06 51 52 42 33</p>", unsafe_allow_html=True)
